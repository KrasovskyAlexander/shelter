let modals = (wrapperSel,overlaySel,modalSel,modalContentSel,closeSel,data)=> {
    ...
    wrapper.addEventListener('click',(e)=>{
        if(e.target && (e.target.classList.contains('pets__cerd') || (e.target.classList.contains("pets__pic")) || (e.target.classList.contains("pets__img")) || (e.target.classList.contains("pets__name")) || (e.target.classList.contains("pets__btng")) )){
            clean();
            ...
            burger.classList.add('burger_onmodal');
    ...
    close.addEventListener('click',e =>{
        ...
        burger.classList.remove('burger_onmodal');
